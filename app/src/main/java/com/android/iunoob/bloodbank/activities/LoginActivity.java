...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Log.d("MyFirebase","onCreate() of LoginActivity.java, current user not null");
            Intent intent = new Intent(getApplicationContext(), Dashboard.class);
            startActivity(intent);
            finish();
        }

        Log.d("MyFirebase","current user null from LoginActivity.java");
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("MyFirebase","signin() of LoginActivity.java");
                final String email = inputemail.getText().toString()+"";
                final String password = inputpassword.getText().toString()+"";

                try {
                    if(password.length()>0 && email.length()>0) {
                        Log.d("MyFirebase","Showing pd from LoginActivity.java");
                        pd.show();
                                ...
                                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (!task.isSuccessful()) {
                                            ...
                                            Log.d("MyFirebase","Starting Dashboard.java");
                                            Intent intent = new Intent(getApplicationContext(), Dashboard.class);
                                            startActivity(intent);
                                            finish();
                                        }
                ...
                {
                    Log.d("MyFirebase","Some exception in LoginActivity.java :"+e.getMessage());
                    e.printStackTrace();
                }
            }
        });
        ...
        Log.d("MyFirebase","Finishing onCreate() of LoginActivity.java, dismissing pd");
        pd.dismiss();
    }
