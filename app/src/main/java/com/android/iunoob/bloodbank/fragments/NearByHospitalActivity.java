...
public class NearByHospitalActivity extends Fragment implements
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            //Toast.makeText(getContext(),"Done 1",Toast.LENGTH_LONG).show();
        }
    ...
    protected synchronized void buildGoogleApiClient() {
        Log.d("NearbyHospital","Building google api client");
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(getActivity(), new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                //Toast.makeText(getContext(),"Test 2",Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlaceUrl.append("&key=" + "AIzaSyCzeoUqsQZM-hVOLKkb3rc6SUhzVOBBuYY");
    ...
    public void onConnectionSuspended(int i) {
        Log.d("NearbyHospital","Connection Suspended");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.d("NearbyHospital","Connection Failed");
    }
   ...
   public void ShowHospitals(double latitude, double longitude)
   {
       ...
       String url = getUrl(latitude, longitude, "hospital");//Marking the request for hospital
       dataTransfer[0] = mMap;
       dataTransfer[1] = url;
       Log.d("NearbyHospital","Executing AsyncTask");
       getNearbyPlacesData.execute(dataTransfer);
       Toast.makeText(getContext(), "Showing Nearby Hospitals", Toast.LENGTH_LONG).show();
   }
}
